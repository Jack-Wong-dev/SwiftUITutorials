...
struct CourseView: View {
    ...
    var body: some View {
        ...
        ZStack(alignment: .top) {
            ...
            //Description Card Container, hidden behind the main card until tapped, where it will then shift downwards and expand.
            ...
            //Main Card.  Will go fullscreen and back when tapped.
            VStack {
                HStack(alignment: .top) {
                    ...
                    //Logo that turns into a close button when card is in fills up the top half of the screen
                    ZStack {
